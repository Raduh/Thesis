...
\subsection{Front-End results}
\subsection{Peformance of the Schematizer}\label{subsec:schematizer_prformance}
\subsection{The API}
...
\end{figure}
\ednote{discuss results. Why are some irrelevant?}

\section{Conclusion}\label{sec:conclusion}
\ednote{more work is to be done to make the results relevant}
