...
Schematizer deployed on an \arxiv index (\ref{subsec:schematizer_performance}).
...
\subsection{Performance of the Schematizer}\label{subsec:schematizer_prformance}
