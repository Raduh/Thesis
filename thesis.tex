...
\ednote{Diagram for index and database}
...
\ednote{Diagram of parallel markup}
...
\ednote{Describe all heuristics (absolute, relative, dynamic, combined)}
...
Figure~\ref{fig:sys_architecture}. \ednote{replace Classifier with Schematizer}
...
implementation. \ednote{make figure a wrap figure}
...
\ednote{Avoid making it sound like a failed attempt}
...
\ednote{Make a concrete and meaningful example}
\ednote{Explain that we don't replace the first child of apply and why}
...
\ednote{link the formulae to papers}
...
\ednote{Remove discussion about less intuitive instantiation}
...
\ednote{Discussion about Ranking, Symsearch}
\ednote{Move Conclusion at the end}
